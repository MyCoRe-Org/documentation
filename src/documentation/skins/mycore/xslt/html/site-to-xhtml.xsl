...
<!--+
  ...
  +--><link rel="stylesheet" href="{$root}skin/basic.css" type="text/css"
                ...
                <link href="{$root}skin/shCore.css" rel="stylesheet" type="text/css" />
                <link href="{$root}skin/shThemeEclipse.css" rel="stylesheet" type="text/css" />
<!--+
  |Javascripts
  +-->
            ...
            <xsl:for-each select="$config/motd/motd-option">
                <xsl:choose>
                    <xsl:when test="@starts-with='true'">
                        <xsl:if test="starts-with($path, @pattern)">
                            <xsl:if
                                test="motd-page/@location='page' or motd-page/@location='both'">
                                <div id="motd-area">
                                    <xsl:apply-templates select="motd-page" />
                                    <xsl:if test="motd-page-url">
                                        <xsl:text> (</xsl:text>
                                        <a>
                                            <xsl:attribute name="href">
